export const translations = {
  ...
  solving: "সেরা রুট গণনা করা হচ্ছে…",
  err_solver: "সলভার ত্রুটি: {msg}",
  ...
  post_sched_invites: "{dayStr}: {name} আমন্ত্রণ (লেভেল {lv}) x{n}",
  post_sched_line: "{dayStr}: {actions}",
  post_act_invite: "{name} আমন্ত্রণ (লেভেল {lv})",
  post_act_buy: "{name} লেভেল {lv} {c}C কেনা",
  post_act_heart: "{name} লেভেল ৫ হার্ট {c}C কেনা",
  post_act_skip: "লেভেল {lv} {c}C বাদ",
  post_act_cleared: "লেভেল {lv} পূর্ণ",
  post_act_complete: "** {name} সম্পন্ন **",
  post_act_ult: "** {ord} আলটিমেট প্রস্তুত ({date}) **",
